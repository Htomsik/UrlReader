...
* Обновление у сервиса статискики происходит только в моменты когда хранилище никто не использует
  > Иногда всё таки запрос сервиса попадает в момент когда хранилише используется и происходят различного рода ошибки, которые по какой то причине глобальный exception handler не видит 
